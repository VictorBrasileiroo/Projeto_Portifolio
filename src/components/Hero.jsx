    ...
    <section className=' w-full min-h-[600px] px-5 pyt-8 flex flex-col gap-12 lg:px-20 lg:flex-row 2xl:max-h-screenn' id='hero'>
      ...
      <div className='w-full flex lg:w-1/2 lg:items-center '>
        ...
        <div className='w-full'>
          ...
          <p className='mt-3 font-Golos text-gray-300 font-medium max-w-[92%] 2xl:text-[18px]'>Desenvolvo sistemas robustos e escaláveis, criando APIs eficientes e arquiteturas seguras. Minha missão é transformar ideias em soluções ágeis e confiáveis para seu projeto.</p>
        </div>
